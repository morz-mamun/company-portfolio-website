export const servicesData = [
  ...
  },
  {
    ...
    className: 'lg:col-span-2 lg:row-span-2 md:col-span-4',
  },
  {
  ...
  },
  {
    ...
    link: '/e-commerce-affiliate-services',
    className: 'lg:col-span-3 md:col-span-2',
  },
  {
    title: 'AI BPO Solutions',
    description:
      'Transform outsourcing with AI-powered solutions that streamline operations, reduce costs, and improve accuracy across customer support, back-office, and sales processes.',
  ...
  {
    title: 'Emerging AI Services (Future-Ready)',
    description:
      'Anticipate the future and gain a competitive edge with AI innovations that drive growth, efficiency, and personalization across industries.',
    image: 'https://pub-3c3fbc3b66a54a4ab707f64d0f564e7d.r2.dev/service01.png',
