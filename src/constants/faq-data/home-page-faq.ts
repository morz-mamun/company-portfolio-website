...
export const homePageFaq: TFaqItem[] = [
  {
    value: 'item-1',
    title: 'How can CompanyX improve my business operations?',
    content: [
      'CompanyX leverages AI automation, digital marketing, and technology solutions to streamline workflows, reduce manual tasks, and enhance productivity across your business.',
    ],
  },
  {
    value: 'item-2',
  ...
  {
    value: 'item-4',
    title: 'How does CompanyX help increase revenue and efficiency?',
    content: [
  ...
  {
    value: 'item-5',
    title: 'What makes CompanyX’ solutions different from other providers?',
    content: [
...
export const homePageFaqSectionData: TFaqSection = {
  ...
  description: 'Answers to common questions about CompanyX and its features.',
  items: homePageFaq,
};
