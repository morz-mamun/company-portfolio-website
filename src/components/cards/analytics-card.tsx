  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <h3 className="font-space-grotesk bg-[linear-gradient(122deg,#E8E8E8_24.49%,#818181_82.24%)] bg-clip-text text-center text-[50px] font-bold text-transparent backdrop-blur-[35px] [-webkit-text-stroke-color:#6C6C6C] [-webkit-text-stroke-width:1px]">
          {item?.count}
        </h3>
