...
export default function SubServiceCard({ item }: { item: TSubServices }) {
  return (
    <div className="flex flex-col items-center justify-center space-y-3 rounded-[12px] border border-[#DBDBDB] px-[6px] py-5 shadow-[0_2px_4.8px_1px_rgba(0,0,0,0.25)] md:space-y-5 md:py-12">
      <Icon
        icon={item?.icon}
