    ...
    <section className="">
      ...
      >
        ...
        <div className="flex justify-center pt-5">
          <button
            type="submit"
            className="flex transform cursor-pointer items-center gap-2 rounded-md border bg-gradient-to-b from-[#0908C3] to-[#0C34E9] px-4 py-2 text-sm font-semibold text-white transition duration-200 ease-in-out hover:scale-105 hover:bg-gradient-to-b hover:from-[#000EAC] hover:to-[#00163C] md:text-base"
          >
