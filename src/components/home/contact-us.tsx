    ...
    <section className="mx-auto max-w-xl lg:max-w-2xl">
      ...
      <form className="mt-8 px-3 md:px-0" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-center pt-5">
          <button
            type="submit"
            className="flex transform cursor-pointer items-center gap-2 rounded-md border bg-gradient-to-b from-[#000750] to-[#002667] px-4 py-2 text-sm font-semibold text-white transition duration-300 ease-in-out hover:scale-95 md:text-base"
          >
