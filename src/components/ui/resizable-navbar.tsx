...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      // }}
      className={cn(
        'relative z-[60] mx-auto hidden w-full flex-row items-center justify-between self-start border-b border-zinc-200 bg-white px-8 py-2 lg:flex dark:border-zinc-800/50 dark:bg-[#030712]',
        visible &&
          'rounded-full bg-white px-4 lg:min-w-[950px] xl:min-w-[1180px] dark:bg-neutral-950/80',
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        'relative z-50 mx-auto flex w-full flex-col items-center justify-between border-b bg-white px-0 py-2 lg:hidden dark:bg-[#030712]',
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      'bg-gradient-to-b from-[#0908C3] to-[#0C34E9] hover:bg-gradient-to-b hover:from-[#000EAC] hover:to-[#00163C] shadow-[inset_2px_3px_9px_0_rgba(0,0,0,0.25)] text-white ',
  };
