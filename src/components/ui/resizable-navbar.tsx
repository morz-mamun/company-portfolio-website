  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && 'bg-white/80 px-4 dark:bg-neutral-950/80',
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        'relative z-50 mx-auto flex w-full max-w-[calc(100vw-4rem)] flex-col items-center justify-between bg-transparent px-0 py-2 lg:hidden',
