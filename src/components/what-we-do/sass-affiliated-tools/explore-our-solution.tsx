...
import {
  ...
  aiContentCreationPlatformsData,
  aiPoweredMarketingFunnelOptimizerData,
  ecommerceGrowthStrategyToolsData,
  saasProductDevelopmentData,
  servicesSectionTitleData,
  smartReviewAndTestimonialCollectorsData,
    ...
    <section className="pt-14">
      ...
      <div className="relative border bg-[#FEFEFE] px-4 md:px-6 dark:bg-[#030712]">
        <div className="relative space-y-14 border-x py-14 md:space-y-32">
          <Service sectionData={saasProductDevelopmentData} />
          <Service sectionData={affiliateTrackingDashboardsData} />
          <Service sectionData={ecommerceGrowthStrategyToolsData} />
          <Service sectionData={aiContentCreationPlatformsData} />
          <Service sectionData={aiPoweredMarketingFunnelOptimizerData} />
          <Service sectionData={smartReviewAndTestimonialCollectorsData} />
