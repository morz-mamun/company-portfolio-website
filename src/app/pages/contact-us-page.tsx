  ...
  return (
    <div>
      ...
      <BannerTitleAndDescription
        sectionData={contactUsBannerData}
        className="!h-[200px] md:!h-[250px] lg:!h-[340px]"
        descriptionClassName="md:!max-w-[600px] !max-w-[300px]"
      />
      <main className="mx-auto min-h-screen overflow-hidden pb-10">
        {/* top content */}
        <div className="mx-auto my-5 grid max-w-6xl grid-cols-1 px-3 md:my-10 md:grid-cols-2 md:gap-10 md:px-4 lg:gap-28">
          {/* contact us form */}
          <ContactUsForm />
          {/* right side content */}
          <div>
